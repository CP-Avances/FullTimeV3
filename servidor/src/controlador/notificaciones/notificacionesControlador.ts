...
class NotificacionTiempoRealControlador {
  ...
  public async ListaNotificacionesRecibidas(req: Request, res: Response): Promise<any> {
    ...
    const REAL_TIME_NOTIFICACION = await pool.query('SELECT r.id, r.id_send_empl, r.id_receives_empl, ' +
  ...
  public async create(req: Request, res: Response): Promise<void> {
    const { id_send_empl, id_receives_empl, id_receives_depa, estado, create_at,
      id_permiso, id_vacaciones, id_hora_extra } = req.body;
    await pool.query('INSERT INTO realtime_noti (id_send_empl, id_receives_empl, id_receives_depa, ' +
