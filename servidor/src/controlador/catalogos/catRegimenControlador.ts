...
class RegimenControlador {
    ...
    public async CrearRegimen(req: Request, res: Response): Promise<Response> {
        ...
        try {
            const { id_pais, descripcion, mes_periodo, dias_mes, trabajo_minimo_mes, trabajo_minimo_horas,
                ...
                calendario_dias, laboral_dias } = req.body;
    ...
    public async ActualizarRegimen(req: Request, res: Response): Promise<void> {
        ...
        const { id_pais, descripcion, mes_periodo, dias_mes, trabajo_minimo_mes, trabajo_minimo_horas,
            ...
            contar_faltas, contar_permiso, vacacion_divisible, antiguedad, antiguedad_fija, anio_antiguedad,
            dias_antiguedad, antiguedad_variable, vacacion_dias_calendario_mes, vacacion_dias_laboral_mes,
            calendario_dias, laboral_dias, id } = req.body;
